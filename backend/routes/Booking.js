...
router.post('/search', async (req, res) => {
    ...
    console.log(result.length)
        ...
        //         origin_date_string=origin_date_time.split("T")[0].substring(1,)
        //         origin_time_string=origin_date_time.split("T")[1].substring(0,5)
        //         origin_result_string=origin_date_string+" "+origin_time_string
        //         JSON.stringify(origin_result_string)
                
        //         result[i].startTime = origin_result_string.toDate();
        //         // console.log(typeof(result[i].startTime))
        //         // console.log(origin_result_string)
        //         // console.log(typeof(origin_result_string))
        //         // result[i].startTime=JSON.stringify(result[i].startTime)
